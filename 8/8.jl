...
let
	...
	pressures = range(1e5, 100e5; length=100)
	temperatures = range(150, 500; length=350)
	...
	scatter(nonstable_t, nonstable_p;color="yellow", markersize=4.0, label="nonstable", legend=:bottomright, xlabel=L"T", ylabel=L"P")
	scatter!(stable_t, stable_p;color="blue", markersize=4.0,label="stable")

	scatter!(errors_t, errors_p; color="red", markersize=4.0, label="errors")
end
...
julia_version = "1.8.1"
manifest_format = "2.0"
project_hash = "227d2ac51874dec4c126c77773d1929ad97e8f5b"
